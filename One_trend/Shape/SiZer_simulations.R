...
proc.time() - ptm
hist(size_of_the_test[1, size_of_the_test[1, ] != 0], breaks = seq(0, 250, by = 5), main = paste0("Size of SiZer: ", (rowSums(size_of_the_test != 0)/N_rep)[1]))
hist(size_of_the_test[2, size_of_the_test[2, ] != 0], breaks = seq(0, 250, by = 5), main = paste0("Size of our method: ", (rowSums(size_of_the_test != 0)/N_rep)[2]))
...
for (a in c(3.5, 4, 4.5, 5)){
  power_of_the_test <- replicate(N_rep, {
    ...
    #stat <- psihat_statistic_ll(y_data_ar_1_with_trend, SiZer_matrix, kernel_ind, sigmahat)[[2]]
  ...
  hist(power_of_the_test[1, power_of_the_test[1, ] != 0], breaks = seq(0, 800, by = 10), main = paste0("Power of SiZer: ", (rowSums(power_of_the_test != 0)/N_rep)[1], ", a = ", a))
  hist(power_of_the_test[2, power_of_the_test[2, ] != 0], breaks = seq(0, 800, by = 10), main = paste0("Power of our method: ", (rowSums(power_of_the_test != 0)/N_rep)[1], ", a = ", a))
}
dev.off()