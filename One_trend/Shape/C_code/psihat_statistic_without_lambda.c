...
double psi_average_ll(double data[], int T, double u, double h, int k_function){
	/*
...
void psihat_statistic_without_lambda(double *y_data, int *T, double *g_t_set, int *N, int *k_function, double *sigmahat, double *maximum, double *values, double *values_with_sign){
