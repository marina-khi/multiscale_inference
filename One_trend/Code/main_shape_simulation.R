...
################################################################################
result_data <- simulations_general(N_rep, different_T, different_alpha, different_slopes, a_hat_data, sigma_eta_hat_data, order = 2, test_problem, q, K2 = 10)
...
# ############################################################
# #All of the above for our method without the correcton term#
# ############################################################
