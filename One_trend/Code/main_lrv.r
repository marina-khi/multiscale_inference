...
###############################
Nsim       <- 1000 #Number of replications for comparison of the estimates
  ...
  for (r in different_r){
    for (slope_fac in different_slope_facs){
      ...
      for (a_1 in different_a){
        pdfname_a_hat = paste0("plots/new/a_hat_histograms_a1=", a_1*100,"_", name_spec, ".pdf")
        pdfname_lrv   = paste0("plots/new/lrv_histograms_a1=", a_1*100,"_", name_spec, ".pdf")
      ...
      if (slope_fac == 10){ 
        pdfname = paste("plots/new/MSE_a1_zoomed_",name_spec,".pdf",sep="")
      ...
      if ((q == 25)&&(r == 10)){ 
         pdfname = paste("plots/new/MSE_a1_",name_spec,".pdf",sep="")
         ...
         pdfname = paste("plots/new/MSE_lrv_",name_spec,".pdf",sep="")
