estimating_variance_new <- function(y_data, L1, order, K2 = 10){
  
  a_hat_method1         <- AR_coefficients(y_data, L1, L1, rep(0,L1), order)
  ...
  a_hat_method2         <- AR_coefficients(y_data, 1, K2, corrections_value, order)
