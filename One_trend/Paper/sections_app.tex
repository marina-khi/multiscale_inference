...
In what follows, we illustrate the multiscale method from Sections \ref{sec-test-shape} by a real-data example. In particular, we apply the test method from Section \ref{sec-test-shape} to a long time series of temperature data from Central England.
