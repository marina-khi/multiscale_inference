...
{\color{red} This part does not go through! We need additional assumptions on $h_{\min}$!
...
\end{align*}
By Proposition \ref{propA-reg-5}, 
\begin{align}\label{proof-1}
\Big|\frac{1}{T}\sum_{t=1}^T \Delta \mathbf{H}_i (\mathcal{U}_{it}) \Big| = \Big| \frac{1}{T}\sum_{t=1}^T \Delta \mathbf{X}_{it}\Big| \leq  \Big| \frac{1}{T}\sum_{t=1}^T \mathbf{X}_{it}\Big| -  \Big| \frac{1}{T}\sum_{t=1}^T \mathbf{X}_{i(t-1)}\Big|= o_P(1).
\end{align}
...
By applying Proposition \ref{propA-reg-4}, \eqref{proof-1} and \eqref{proof-2}, the statement of the theorem follows.
\end{proof}
