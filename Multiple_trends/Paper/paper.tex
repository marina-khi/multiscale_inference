...
& \le 2 \max_{1 \le i < j \le n} \max_{(u,h) \in \mathcal{G}_T}\left| \sum_{t=1}^T w_{t,T}(u,h) (\varepsilon_{it} - \bar{\varepsilon}_i) \right|
\end{align*}

Now to the second summand in \eqref{ineq-diff-0}. By the definition of kernel averages, we have
\begin{align*}
