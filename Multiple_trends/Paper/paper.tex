...
&\,= \frac{\sum\nolimits_{t=1}^T w_{t,T}(u,h) \, \big\{ \widehat{\sigma}_i (Z_{it} - \bar{Z}_i) - \widehat{\sigma}_j (Z_{jt} - \bar{Z}_j) \big\}\sum\nolimits_{t=1}^T w_{t,T}(u,h) \, \big\{ \widehat{\sigma}_{i^\prime} (Z_{{i^\prime}t} - \bar{Z}_{i^\prime}) - \widehat{\sigma}_{j^\prime} (Z_{{j^\prime}t} - \bar{Z}_{j^\prime}) \big\}}
...
\begin{align*}
&\ex\left[\frac{\widehat{\sigma}_i\widehat{\sigma}_{i^\prime}\left(\sum\nolimits_{t=1}^T w_{t,T}(u,h) \, (Z_{it} - \bar{Z}_i)\right) \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \,  (Z_{{i^\prime}t} - \bar{Z}_{i^\prime}) \right) }{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i^\prime}^2 + \widehat{\sigma}_{j^\prime}^2\}^{1/2}}\right] =\\
&=	\ex\left[\frac{\widehat{\sigma}_i \widehat{\sigma}_{i^\prime}}{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i^\prime}^2 + \widehat{\sigma}_{j^\prime}^2\}^{1/2}}\right] \ex \left[\left(\sum\nolimits_{t=1}^T w_{t,T}(u,h) \, (Z_{it} - \bar{Z}_i)\right)\left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \,  (Z_{{i^\prime}t} - \bar{Z}_{i^\prime}) \right)\right]
\end{align*}
and
\begin{align*}
&\ex\left[\frac{\widehat{\sigma}_i\widehat{\sigma}_{i^\prime}\left(\sum\nolimits_{t=1}^T w_{t,T}(u,h) \, (Z_{it} - \bar{Z}_i)\right) \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \,  (Z_{{i^\prime}t} - \bar{Z}_{i^\prime}) \right) }
{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i^\prime}^2 + \widehat{\sigma}_{j^\prime}^2\}^{1/2}}\bigg| \X_{it}\right] =\\
&=	\frac{\widehat{\sigma}_i \widehat{\sigma}_{i^\prime}}{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i^\prime}^2 + \widehat{\sigma}_{j^\prime}^2\}^{1/2}}\ex \left[\left(\sum\nolimits_{t=1}^T w_{t,T}(u,h) \, (Z_{it} - \bar{Z}_i)\right)\left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \,  (Z_{{i^\prime}t} - \bar{Z}_{i^\prime}), \right)\right]
\end{align*}
...
\begin{align*}
&\ex \left[\left(\sum\nolimits_{t=1}^T w_{t,T}(u,h) \, (Z_{it} - \bar{Z}_i)\right)\left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \,  (Z_{{i^\prime}t} - \bar{Z}_{i^\prime}) \right)\right] = \\
&\quad = \ex \left[\sum\nolimits_{t=1}^T w_{t,T}(u,h) \, (Z_{it} - \bar{Z}_i)\right] \ex \left[ \sum\nolimits_{t=1}^T w_{t,T}(u,h) \,  (Z_{{i^\prime}t} - \bar{Z}_{i^\prime})\right] =\\
&\quad = 0
\end{align*}
and
\begin{align*}
...
\begin{align*}
&\ex \left[\left(\sum\nolimits_{t=1}^T w_{t,T}(u,h) \, (Z_{it} - \bar{Z}_i)\right)\left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \,  (Z_{{i^\prime}t} - \bar{Z}_{i^\prime}) \right)\right] = \\
&\quad = \ex \left[\left(\sum\nolimits_{t=1}^T w_{t,T}(u,h) \, (Z_{it} - \bar{Z}_i)\right)^2\right] =\\
&\quad = \ex \left[\sum\nolimits_{t=1}^T w^2_{t,T}(u,h) \, (Z_{it} - \bar{Z}_i)^2\right] + \ex \left[\sum_{t, s =1, t\neq s}^T w_{t,T}(u,h)w_{s,T}(u,h) \, (Z_{it} - \bar{Z}_i)(Z_{is} - \bar{Z}_i)\right] =\\
&\quad =\sum\nolimits_{t=1}^T w^2_{t,T}(u,h) \ex \left[Z_{it}^2 \right] - 2\sum\nolimits_{t=1}^T w^2_{t,T}(u,h) \ex \left[Z_{it}\bar{Z}_i \right] + \sum\nolimits_{t=1}^T w^2_{t,T}(u,h) \ex \left[\bar{Z}_{i}^2  \right] + \\
&\quad \quad + \sum_{t, s =1, t\neq s}^T w_{t,T}(u,h)w_{s,T}(u,h)\ex [Z_{it} Z_{is}] -\sum_{t, s =1, t\neq s}^T w_{t,T}(u,h)w_{s,T}(u,h)\ex [\bar{Z}_{i} Z_{is}] -\\
&\quad \quad - \sum_{t, s =1, t\neq s}^T w_{t,T}(u,h)w_{s,T}(u,h)\ex [Z_{it} \bar{Z}_{i}] + \sum_{t, s =1, t\neq s}^T w_{t,T}(u,h)w_{s,T}(u,h)\ex [\bar{Z}_{i}^2].
\end{align*}
Since $\{Z_{it}\}_{t}$ are i.i.d. standard normal random variables, we have obvious equalities: $\ex \left[Z_{it}^2 \right] = 1$, $\ex \left[\bar{Z}_{i}^2\right] = 1/T$, $\ex [Z_{it} Z_{is}] = \ex[Z_{it}] \ex[Z_{is}] = 0$ for $t \neq s$ and $\ex [Z_{it} \bar{Z}_{i}] = 1/T$. Then, knowing that $\sum\nolimits_{t=1}^T w^2_{t,T}(u,h) = 1$ from \eqref{sum-weights}, we have
\begin{align*}
&\ex \left[\left(\sum\nolimits_{t=1}^T w_{t,T}(u,h) \, (Z_{it} - \bar{Z}_i)\right)^2\right] =\\
&\quad =\sum\nolimits_{t=1}^T w^2_{t,T}(u,h) - \frac{2}{T}\sum\nolimits_{t=1}^T w^2_{t,T}(u,h) + \frac{1}{T}\sum\nolimits_{t=1}^T w^2_{t,T}(u,h)  - \\
&\quad \quad  -\frac{2}{T}\sum_{t, s =1, t\neq s}^T w_{t,T}(u,h)w_{s,T}(u,h) + \frac{1}{T}\sum_{t, s =1, t\neq s}^T w_{t,T}(u,h)w_{s,T}(u,h) = \\
&\quad =  1 - \frac{1}{T} \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \right)^2.
\end{align*}
Then,
\begin{align*}
&\ex\left[\frac{\widehat{\sigma}_i\widehat{\sigma}_{i^\prime}\left(\sum\nolimits_{t=1}^T w_{t,T}(u,h) \, (Z_{it} - \bar{Z}_i)\right) \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \,  (Z_{{i^\prime}t} - \bar{Z}_{i^\prime}) \right) }
{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i^\prime}^2 + \widehat{\sigma}_{j^\prime}^2\}^{1/2}}\right] =\\
&=	\ex\left[\frac{\widehat{\sigma}_i^2}{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i}^2 + \widehat{\sigma}_{j^\prime}^2\}^{1/2}}\right] \left(1 - \frac{1}{T} \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \right)^2\right)
\end{align*}
and
\begin{align*}
&\ex\left[\frac{\widehat{\sigma}_i\widehat{\sigma}_{i^\prime}\left(\sum\nolimits_{t=1}^T w_{t,T}(u,h) \, (Z_{it} - \bar{Z}_i)\right) \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \,  (Z_{{i^\prime}t} - \bar{Z}_{i^\prime}) \right) }
{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i^\prime}^2 + \widehat{\sigma}_{j^\prime}^2\}^{1/2}}\bigg| \X_{it}\right] =\\
&=	\frac{\widehat{\sigma}_i^2}{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i}^2 + \widehat{\sigma}_{j^\prime}^2\}^{1/2}}\left(1 - \frac{1}{T} \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \right)^2\right).
\end{align*}
...
& = \ex \left[\frac{\widehat{\sigma}_i\widehat{\sigma}_{i^\prime}\left(\sum\nolimits_{t=1}^T w_{t,T}(u,h) \, (Z_{it} - \bar{Z}_i)\right) \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \,  (Z_{{i^\prime}t} - \bar{Z}_{i^\prime}) \right) }{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i^\prime}^2 + \widehat{\sigma}_{j^\prime}^2\}^{1/2}} \bigg|\X_{it}\right]- \\
&\quad - \ex \left[\frac{\widehat{\sigma}_j\widehat{\sigma}_{i^\prime}\left(\sum\nolimits_{t=1}^T w_{t,T}(u,h) \, (Z_{jt} - \bar{Z}_j)\right) \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \,  (Z_{{i^\prime}t} - \bar{Z}_{i^\prime}) \right) }{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i^\prime}^2 + \widehat{\sigma}_{j^\prime}^2\}^{1/2}}\bigg|\X_{it}\right] - \\
&\quad - \ex \left[\frac{\widehat{\sigma}_i\widehat{\sigma}_{j^\prime}\left(\sum\nolimits_{t=1}^T w_{t,T}(u,h) \, (Z_{it} - \bar{Z}_i)\right) \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \,  (Z_{{j^\prime}t} - \bar{Z}_{j^\prime}) \right) }{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i^\prime}^2 + \widehat{\sigma}_{j^\prime}^2\}^{1/2}} \bigg|\X_{it}\right]+ \\
&\quad + \ex \left[\frac{\widehat{\sigma}_j\widehat{\sigma}_{j^\prime}\left(\sum\nolimits_{t=1}^T w_{t,T}(u,h) \, (Z_{jt} - \bar{Z}_j)\right) \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \,  (Z_{{j^\prime}t} - \bar{Z}_{j^\prime}) \right) } {\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i^\prime}^2 + \widehat{\sigma}_{j^\prime}^2\}^{1/2}}\bigg|\X_{it}\right]=\\
&= \begin{cases}
0, \text{ if } i \neq i^\prime, j^\prime \text{ and } j \neq i^\prime, j^\prime;\\
1 - \frac{1}{T} \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \right)^2, \text{ if } i = i^\prime \text{ and } j = j^\prime;\\
\frac{\widehat{\sigma}_i^2}{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i}^2 + \widehat{\sigma}_{j^\prime}^2\}^{1/2}}\left(1 - \frac{1}{T} \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \right)^2\right), \text{ if } i = i^\prime \text{ but } j \neq j^\prime;\\
\frac{\widehat{\sigma}_j^2}{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i^\prime}^2 + \widehat{\sigma}_{j}^2\}^{1/2}}\left(1 - \frac{1}{T} \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \right)^2\right), \text{ if } j = j^\prime \text{ but } i \neq i^\prime;\\
-\frac{\widehat{\sigma}_j^2}{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{j}^2 + \widehat{\sigma}_{j^\prime}^2\}^{1/2}}\left(1 - \frac{1}{T} \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \right)^2\right), \text{ if } j = i^\prime \text{ but } i \neq j^\prime;\\
-\frac{\widehat{\sigma}_i^2}{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i^\prime}^2 + \widehat{\sigma}_{i}^2\}^{1/2}}\left(1 - \frac{1}{T} \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \right)^2\right), \text{ if } i = j^\prime \text{ but }  j\neq i^\prime
\end{cases} 
\end{align*}
...
1 - \frac{1}{T} \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \right)^2, \text{ if } i = i^\prime \text{ and } j = j^\prime;\\
\ex\left[\frac{\widehat{\sigma}_i^2}{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i}^2 + \widehat{\sigma}_{j^\prime}^2\}^{1/2}}\right]\left(1 - \frac{1}{T} \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \right)^2\right), \text{ if } i = i^\prime \text{ but } j \neq j^\prime;\\
\ex\left[\frac{\widehat{\sigma}_j^2}{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i^\prime}^2 + \widehat{\sigma}_{j}^2\}^{1/2}}\right]\left(1 - \frac{1}{T} \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \right)^2\right), \text{ if } j = j^\prime \text{ but } i \neq i^\prime;\\
-\ex\left[\frac{\widehat{\sigma}_j^2}{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{j}^2 + \widehat{\sigma}_{j^\prime}^2\}^{1/2}}\right]\left(1 - \frac{1}{T} \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \right)^2\right), \text{ if } j = i^\prime \text{ but } i \neq j^\prime;\\
-\ex\left[\frac{\widehat{\sigma}_i^2}{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i^\prime}^2 + \widehat{\sigma}_{i}^2\}^{1/2}}\right]\left(1 - \frac{1}{T} \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \right)^2\right), \text{ if } i = j^\prime \text{ but }  j\neq i^\prime.
\end{cases} 
\end{align*}
...
\max_{\substack{1 \leq i < j \leq n,\\ 1 \le j^\prime \le n, j^\prime \neq i, j^\prime \neq j}} &\left| \frac{\widehat{\sigma}_i^2}{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i}^2 + \widehat{\sigma}_{j^\prime}^2\}^{1/2}}-  \ex\left[\frac{\widehat{\sigma}_i^2}{\{\widehat{\sigma}_i^2 + \widehat{\sigma}_j^2\}^{1/2}\{\widehat{\sigma}_{i}^2 + \widehat{\sigma}_{j^\prime}^2\}^{1/2}}\right] \right| \cdot \\
&\quad \cdot \left(1 - \frac{1}{T} \left( \sum\nolimits_{t=1}^T w_{t,T}(u,h) \right)^2\right)
\end{align*}
