...
\color{red}{The main technical tool for proving Proposition \ref{propA-anticon-equality} are anti-concentration bounds for Gaussian random vectors. The following proposition slightly generalizes anti-concentration results derived in \cite{Chernozhukov2015}, in particular Theorem 3 therein. 
...
\end{equation}}
which immediately implies the statement of Theorem \ref{theo-stat-equality}. \color{red}{For the proof of \eqref{eq-theo-stat-equality-step2}, we use the following simple lemma: 
