...
Since the data used in the analysis of the trends in the GDP growth in Section 7.1 were collected from multiple sources some of which are not freely available (e.g., Refinitiv Datastream),
we do not publish neither these data, nor the code used for the analysis. The performance of the multiscale method is illustrated by the comparison of the trends in the house price data
Described in Section 7.2 and by the simulation study presented in Section 6. We describe the data and the code used for these illustrations below.
...
A full description of the variables comprising the dataset and how they were collected can be found in the following paper:
...
As stated on the database website, the database "captures the near-universe of advanced-country macroeconomic and asset price dynamics, covering on average over 90 percent of advanced-economy output
and over 50 percent of world output".

A full description of the data and how it is collected can be found in the following paper:
...
The Jordà-Schularick-Taylor Macrohistory Database is freely available and may be used, shared and adapted subject to Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0).
...
The overall structure of the code is as follows. There are three main files each of which produces a specific part of the simulations and applications:
...
All programs are written in R. They are all quite self-explanatory and commented. The code is self-sufficient and easy to run. 
