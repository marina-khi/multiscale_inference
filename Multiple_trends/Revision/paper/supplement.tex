...
\footnotesize{
\begin{center}
\caption{Size of the multiscale test for different number of time series $n$, sample sizes $T$ and nominal sizes $\alpha$ for the dyadic grid. Each panel corresponds to a differentnumber of time series $n$.}\label{tab:size:dyadic}
\begin{subtable}[b]{0.48\textwidth}
\centering
