...
{\color{red}\begin{subtable}[b]{0.32\textwidth}
...
{\color{red}\begin{subtable}[c]{0.24\textwidth}
\centering  
...
\begin{table}[t!]
\centering
\caption{Empirical probabilities that $\{ \widehat{G}_1,\ldots,\widehat{G}_{\widehat{N}}\} = \{ G_1,G_2,G_3\}$ for the proposed clustering approach with estimated long-run variance ($\mathcal{T}_{\text{MS}}$) for $\alpha = 0.05$, the proposed clustering approach with true theoretical value of the long-run variance ($\mathcal{T}_{\text{MS, true lrv}}$) and the benchmark procedures with various bandwidths ($\mathcal{T}_{\text{bm, }1} - \mathcal{T}_{\text{bm, }6}$) for different sample sizes $T$.}\label{tab:clustering:comparison}
\newcolumntype{Z}{>{\centering\arraybackslash}X}
{\color{red}
