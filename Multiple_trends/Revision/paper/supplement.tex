...
As can be seen, for large sample size $T=500$ the size numbers in Table \ref{tab:grids} are quite stable across the three different grids. Furthermore, even though the power numbers increase as the grid gets finer, the test has reasonable power properties for all of the choices of the grid. %This demonstrates that 
