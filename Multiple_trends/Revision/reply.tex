...
\end{figure}
\begin{figure}[p!]
\includegraphics[width=\textwidth]{output/beta_infl_T_250}
\caption{Histogram of the estimated value of $\beta_{i, 4}$ (inflation) for various countries for $T = 250$.}\label{fig:para:infl:250}
\end{figure}
