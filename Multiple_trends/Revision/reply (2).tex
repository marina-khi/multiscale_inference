...
{\color{red}\item We calculate the Gaussian quantiles based on $5000$ samples, and the size and power calculations are also done with $5000$ samples.}
...
\input{output/15_ts_10_10_small_error_var_size}
\end{center}}
\footnotesize{
\begin{center}
...
\renewcommand{\arraystretch}{1.2}
\input{output/15_ts_10_10_small_error_var_power_b_25}
\end{subtable}
\begin{subtable}[b]{0.32\textwidth}
\centering
\caption{$b = 0.50$}\label{tab:power1_050}
\renewcommand{\arraystretch}{1.2}
\input{output/15_ts_10_10_small_error_var_power_b_50}
\end{subtable}
\begin{subtable}[b]{0.32\textwidth}
\centering
...
\label{tab:size2}
\renewcommand{\arraystretch}{1.2}
\input{output/15_ts_25_25_small_error_var_size}
\end{center}}
\footnotesize{
\begin{center}
...
\renewcommand{\arraystretch}{1.2}
\input{output/15_ts_25_25_small_error_var_power_b_25}
\end{subtable}
\begin{subtable}[b]{0.32\textwidth}
\centering
\caption{$b = 0.50$}\label{tab:power2_050}
\renewcommand{\arraystretch}{1.2}
\input{output/15_ts_25_25_small_error_var_power_b_50}
\end{subtable}
\begin{subtable}[b]{0.32\textwidth}
\centering
...
\label{tab:size3}
\renewcommand{\arraystretch}{1.2}
\input{output/15_ts_0_25_no_covariates_size}
\end{center}}
\vspace{-0.4cm}
\end{table}
...
\footnotesize{
\begin{center}
\caption{Size of the multiscale test for $n = 25$ for different sample sizes $T$ and nominal sizes $\alpha$ ($\phi = 0.1$ and $\rho = 0.1$).}
...
\footnotesize{
\begin{center}
\caption{Power of the multiscale test for $n = 25$ for different sample sizes $T$ and nominal sizes $\alpha$  ($\phi = 0.1$ and $\rho = 0.1$). Each panel corresponds to a different height parameter $b$ of the bump function.}\label{tab:power:dyadic:25}
\begin{subtable}[b]{0.32\textwidth}
\centering
\caption{$b = 0.25$}%\label{tab:power1_025}
\renewcommand{\arraystretch}{1.2}
...
\footnotesize{
\begin{center}
\caption{Size of the multiscale test for $n = 50$ for different sample sizes $T$ and nominal sizes $\alpha$ ($\phi = 0.1$ and $\rho = 0.1$).}
...
\footnotesize{
\begin{center}
\caption{Power of the multiscale test for $n = 50$ for different sample sizes $T$ and nominal sizes $\alpha$  ($\phi = 0.1$ and $\rho = 0.1$). Each panel corresponds to a different height parameter $b$ of the bump function.}\label{tab:power:dyadic:50}
\begin{subtable}[b]{0.32\textwidth}
\centering
\caption{$b = 0.25$}%\label{tab:power1_025}
\renewcommand{\arraystretch}{1.2}
...
\footnotesize{
\begin{center}
\caption{Size of the multiscale test for $n = 100$ for different sample sizes $T$ and nominal sizes $\alpha$ ($\phi = 0.1$ and $\rho = 0.1$).}
...
\footnotesize{
\begin{center}
\caption{Power of the multiscale test for $n = 100$ for different sample sizes $T$ and nominal sizes $\alpha$  ($\phi = 0.1$ and $\rho = 0.1$). Each panel corresponds to a different height parameter $b$ of the bump function.}\label{tab:power:dyadic:100}
\begin{subtable}[b]{0.32\textwidth}
\centering
\caption{$b = 0.25$}%\label{tab:power1_025}
\renewcommand{\arraystretch}{1.2}
