...
\begin{itemize}
	...
	\item Played a bit with the shape of the functions: with smaller scales and smaller bumps for the third function, neither our procedure, not the benchmarks can recognize anything.
