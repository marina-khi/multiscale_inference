...
\item \label{C-reg2} The matrix $\ex[\Delta \X_{it} \Delta \X_{it}^\top]$ {\color{red}with $\Delta \X_{it} = \X_{it} - \X_{it-1}$} is invertible for each $i$.
