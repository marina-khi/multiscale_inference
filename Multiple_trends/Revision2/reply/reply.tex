...
\begin{itemize}
\item We consider the model without the fixed effects $\alpha_i$.
\item For each of the time series $i = 1, \ldots, n$, we calculate the UCB as described in \cite{Kim2016}.
...
\item We calculate how many times we reject the null for our method and for the naive competitor. The results are presented in ...
\end{itemize}
