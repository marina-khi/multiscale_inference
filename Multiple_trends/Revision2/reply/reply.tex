...
\renewcommand{\arraystretch}{1.2}  
\begin{center}
\caption{Empirical size and power of the naive competitor from \cite{Kim2016} for $\alpha = 0.05$ for different time series lengths $T$ and bump heights $b$, where $b = 0$ corresponds to the null and $b = 0.25,0.5,0.75$ to three different alternatives.}\label{tab:sizepower_UCB}
\centering  
...
\footnotesize{
\begin{center}
\caption{An example of the uniform confidence bands for two time series $i=1$ and $ j \in \{2, \ldots, 15\}$ for $T=500$ and $b=0.25, 0.50, 0.75$.}\label{fig:UCB}
\begin{subfigure}[b]{0.31\textwidth}
    \centering
...
\footnotesize{
\begin{center}
\caption{Time-varying error variance $\sigma^2(u)$ for $u \in [0, 1]$.}\label{fig:SV_plot}
    \centering
...
\footnotesize{
\begin{center}
\caption{Empirical size of the multiscale test for different time series lengths $T$ and nominal sizes $\alpha$ in case of time-varying error variance.}\label{tab:size_SV}
\centering  
...
\footnotesize{
\begin{center}
\caption{Actual power of the multiscale test for different time series lengths $T$ and nominal sizes $\alpha$ in case of time-varying error variance.
Each panel gives the results for a different bump height $b$, where $b = 0.25,0.5,0.75$ corresponds to three different alternatives of $m_1$.}\label{tab:actualpower_SV}
...
\footnotesize{
\begin{center}
\caption{Majority power of the multiscale test for different time series lengths $T$ and nominal sizes $\alpha$ in case of time-varying error variance.
Each panel gives the results for a different bump height $b$, where $b = 0.25,0.5,0.75$ corresponds to three different alternatives of $m_1$.}\label{tab:majoritypower_SV}
\begin{subtable}[b]{0.32\textwidth}
\centering  
\caption{$b=0.25$}
...
\footnotesize{
\begin{center}
\caption{Full power of the multiscale test for different time series lengths $T$ and nominal sizes $\alpha$ in case of time-varying error variance.
Each panel gives the results for a different bump height $b$, where $b = 0.25,0.5,0.75$ corresponds to three different alternatives of $m_1$.}\label{tab:fullpower_SV}
\begin{subtable}[b]{0.32\textwidth}
\centering  
\caption{$b=0.25$}
