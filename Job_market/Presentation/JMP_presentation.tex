...
\begin{itemize}
	\item to introduce scaling factor in the trend function, that allow for adjusting for the size of the country (population, density, testing regimes, etc.);\pause
	\item to connect with data-driven techniques such as machine learning;\pause
	\item to build in some policy changes.
\end{itemize}
\end{frame}
