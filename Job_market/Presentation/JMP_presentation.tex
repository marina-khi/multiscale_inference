...
\begin{frame}{Literature}
	...
	Studies of COVID-19:
	\begin{itemize}
		\item {\color<6>{mLightBrown}Dong et al. (2020)}, Gu et al. (2020), Li and Linton (2020), Jiang et al. (2020).
	\end{itemize}
\end{frame}
...
\vspace{-2mm}
\begin{equation*}
X_{it} = \lambda_i\Big(\frac{t}{T}\Big) + %u_{it} %\quad \text{with} \quad u_{it} 
\sqrt{\lambda_i\Big(\frac{t}{T}\Big)} \eta_{it},
\end{equation*}
...
Plot the results of pairwise comparison $\mathcal{F}_{\text{reject}}(i, j)$ \pause:
\begin{align*}
...
\begin{itemize}
\item Five countries: Germany, Italy, Spain, France and the UK.\pause
\item $T = 150$ days. \pause
\item The data is aligned by weekdays: first Monday after reaching $100$ cases as $t=1$.\pause
\item Lengths of time intervals $7, 14, 21, 28$ days. The intervals start at days $1, 8, 15, \ldots$ and $4, 11, 19, \ldots$\pause
