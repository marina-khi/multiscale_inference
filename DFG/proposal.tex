...
The statistical problem of comparing trends has a wide range of applications in economics, finance and other fields such as climatology and biology. In economics, a common issue is to compare trends in real GDP across different countries (cp.\ \cite{Grier1989}). %It is highly debated whether real GDP growth is faster in economies in transition (such as Brazil, China or India) than in developed countries.
...
\vspace{10pt}
>>>>>>> 75fab7ef251be431805238987fe8a97f8cb1cfa6
...
<<<<<<< HEAD
Vogt, Michael, Professur, tenured position
=======
