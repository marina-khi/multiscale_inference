...
\begin{table}[H]
    \begin{center}
        ...
        \label{tab:power_025}
        \centering
        \input{Coding/output/powertable_25}
    \end{center}
\end{table}
...
\begin{table}[H]
    \begin{center}
        ...
        \label{tab:power_050}
        \centering
        \input{Coding/output/powertable_50}
    \end{center}
\end{table}
...
\begin{table}[H]
    \begin{center}
        ...
        \label{tab:power_065}
        \centering
        \input{Coding/output/powertable_65}
    \end{center}
\end{table}
...
\begin{table}[H]
    \begin{center}
        ...
        \label{tab:power_075}
        \centering
        \input{Coding/output/powertable_75}
    \end{center}
\end{table}
...
\begin{table}[H]
    \begin{center}
        ...
        \label{tab:power_100}
        \centering
        \input{Coding/output/powertable_100}
    \end{center}
\end{table}
