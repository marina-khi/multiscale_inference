...
\begin{table}[H]
    \begin{center}
        ...
        \label{tab:size}
        \centering
        \input{Coding/output/sizetable}
    \end{center}
\end{table}

\begin{table}[H]
    \begin{center}
        \caption{Power of the test calculated for different sample sizes (T = 250, 350, 500, 1000) and confident levels ($\alpha$ = 0.01, 0.05, 0.10) for Noise to Signal ratio equal to 2}
        \label{tab:power_nts2}
        \centering
        \input{Coding/output/powertable_nts2}
    \end{center}
\end{table}

\begin{table}[H]
    \begin{center}
        \caption{Power of the test calculated for different sample sizes (T = 250, 350, 500, 1000) and confident levels ($\alpha$ = 0.01, 0.05, 0.10) for Noise to Signal ratio equal to 3}
        \label{tab:power_nts3}
        \centering
        \input{Coding/output/powertable_nts3}
    \end{center}
\end{table}

\begin{table}[H]
    \begin{center}
        \caption{Power of the test calculated for different sample sizes (T = 250, 350, 500, 1000) and confident levels ($\alpha$ = 0.01, 0.05, 0.10) for Noise to Signal ratio equal to 4}
        \label{tab:power_nts4}
        \centering
        \input{Coding/output/powertable_nts4}
    \end{center}
\end{table}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=150mm]{Coding/Output/threegraphics.jpg}
