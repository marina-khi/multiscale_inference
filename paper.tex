...
\begin{table}[H]
    \begin{center}
        ...
        \label{tab:size}
        \centering
        \input{Coding/output/sizetable_ll_testing_zero}
    \end{center}
\end{table}
...
\begin{table}[H]
    \begin{center}
        ...
        \label{tab:power_025}
        \centering
        \input{Coding/output/powertable_25_ll_testing_zero}
    \end{center}
\end{table}
...
\begin{table}[H]
    \begin{center}
        ...
        \label{tab:power_050}
        \centering
        \input{Coding/output/powertable_50_ll_testing_zero}
    \end{center}
\end{table}
...
\begin{table}[H]
    \begin{center}
        ...
        \label{tab:power_065}
        \centering
        \input{Coding/output/powertable_65_ll_testing_zero}
    \end{center}
\end{table}
...
\begin{table}[H]
    \begin{center}
        ...
        \label{tab:power_075}
        \centering
        \input{Coding/output/powertable_75_ll_testing_zero}
    \end{center}
\end{table}
...
\begin{table}[H]
    \begin{center}
        ...
        \label{tab:power_100}
        \centering
        \input{Coding/output/powertable_100_ll_testing_zero}
    \end{center}
\end{table}
