...
#'   \eqn{m_i} in the model \eqn{Y_{i, t} = m_i(t/T) + \epsilon_{i, t}} with
#'   time series errors \eqn{\epsilon_{i, t}} is provided. The method was first
...
#'
#'   All these methods require an estimator of the long-run error variance
