...
simulate_gaussian <- function(t_len, n_ts, sim_runs, gset, ijset, sigma_vec, deriv_order = 0L, epidem = FALSE) {
    .Call(`_multiscale_simulate_gaussian`, t_len, n_ts, sim_runs, gset, ijset, sigma_vec, deriv_order, epidem)
}
...
compute_multiple_statistics <- function(t_len, n_ts, data, gset, ijset, sigma_vec, epidem = FALSE) {
    .Call(`_multiscale_compute_multiple_statistics`, t_len, n_ts, data, gset, ijset, sigma_vec, epidem)
}
...
compute_statistics <- function(t_len, data, gset, sigma, deriv_order) {
    .Call(`_multiscale_compute_statistics`, t_len, data, gset, sigma, deriv_order)
}
