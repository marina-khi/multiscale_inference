...
As we can see from the plots, time series for these countries are relatively similar to each other. For example, we do not detect any significant difference between trends in Germany and Spain after 31st day, or between Germany and Italy before 46th day and after 77th day of the course of the pandemic, or between Germany and France after 31st day. The only pairwise comparison that shows significance difference between functions $\lambda_i$ and $\lambda_j$ during the most part of the considered time period is the comparison between Germany and United Kingdom.
\begin{figure}[t!]
\begin{subfigure}[b]{0.475\textwidth}
...
One of the main arguments against any possibility of comparing rates of the spread of infection in different countries, is the fact that different ocu
