...
\item We consider different values for $T$ and $n$, in particular, $T \in \{100,200\}$ and $n \in \{5,10,50\}$. 
...
\end{itemize}
Each simulation experiment is based on $R=10 000$ simulated samples $\mathcal{\X}$ of count data. 
