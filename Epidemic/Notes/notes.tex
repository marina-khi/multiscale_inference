...
\item We consider different values for $T$ and $n$, in particular, $T \in \{50,100\}$ and $n \in \{5,10,50,100\}$. 
...
\end{itemize}
Each simulation experiment is based on $R=1000$ simulated samples $\mathcal{\X}$ of count data. 
