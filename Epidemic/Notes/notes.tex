...
In the second part of our simulation study, we estimate the statistical power of the test. In order to do this, we calculate the percentage of the cases where we correctly determined that the first mean function is different from the others while at the same time we did not find any significant differences between all of the other mean functions. That is, based on $R=5 000$ simulated samples $\mathcal{\X}$ of count data we calculate the percentage of simulation runs where the set of $\intervals(1, j)$ is not empty at least for one $j \in \{2, \ldots, n\}$ and at the same time all of the other sets $\intervals(i, j)$ with $\{(i, j): 2 \leq i < j \leq n\}$ are empty.

The results of the power simulations for the different heights of the peak (see Figure \ref{fig:lambda_fcts_height}) are presented in Table \ref{tab:sim:power:1}. The results of the power simulations for the different locations of the peak (see Figure \ref{fig:lambda_fcts_shift}) are presented in Table \ref{tab:sim:power:2}.
...
\end{subfigure}
\caption{Plot of the functions $\lambda_1$ and $\lambda_2$ for different simulation scenarios.}
\end{figure}


\begin{table}[t!]
\footnotesize{
\caption{Power of the test for different number of time series $n \in \{5, 10, 50\}$ for different heights of the peak.}\label{tab:sim:power:1}
\newcolumntype{C}[1]{>{\hsize=#1\hsize\centering\arraybackslash}X}
\newcolumntype{Z}{>{\centering\arraybackslash}X}
\begin{tabularx}{\textwidth}{l Z@{\hskip 6pt}Z@{\hskip 6pt}Z Z@{\hskip 6pt}Z@{\hskip 6pt}Z Z@{\hskip 6pt}Z@{\hskip 6pt}Z} 
\toprule
...
\begin{table}[t!]
\footnotesize{
\caption{Power of the test for different number of time series $n \in \{5, 10, 50\}$ for different locations of the peak.}\label{tab:sim:power:2}
\newcolumntype{C}[1]{>{\hsize=#1\hsize\centering\arraybackslash}X}
\newcolumntype{Z}{>{\centering\arraybackslash}X}
\begin{tabularx}{\textwidth}{l Z@{\hskip 6pt}Z@{\hskip 6pt}Z Z@{\hskip 6pt}Z@{\hskip 6pt}Z Z@{\hskip 6pt}Z@{\hskip 6pt}Z} 
\toprule
...
In what follows, we carry out some robustness checks to assess how sensitive the multiscale test is. First, we vary the overdispersion parameter $\sigma$ to see how sensitive our test is to the noise-to-signal ratio. The results of the size simulations are presented in Tables  \ref{s:tab:sim:size:1} and \ref{s:tab:sim:size:2}.
...
Moreover, we repeat the simulation exercises of Section \ref{subsec:sim} for the following function:
\[ \lambda(u) = 5000 \exp\Big(-\frac{(10 u-3)^2}{2}\Big) + 500. \]
The results are presented in Tables \ref{s:tab:sim:size:3},  \ref{s:tab:sim:size:4} and \ref{s:tab:sim:size:5}.
...
\begin{table}[t!]
\footnotesize{
\caption{Power of the test for different number of time series $n \in \{5, 10, 50\}$, $\sigma = 10$ (different heights).}\label{s:tab:sim:power:1}
\newcolumntype{C}[1]{>{\hsize=#1\hsize\centering\arraybackslash}X}
\newcolumntype{Z}{>{\centering\arraybackslash}X}
\begin{tabularx}{\textwidth}{l Z@{\hskip 6pt}Z@{\hskip 6pt}Z Z@{\hskip 6pt}Z@{\hskip 6pt}Z Z@{\hskip 6pt}Z@{\hskip 6pt}Z} 
\toprule
...
\begin{table}[t!]
\footnotesize{
\caption{Power of the test for different number of time series $n \in \{5, 10, 50\}$, $\sigma = 20$ (different heights).}\label{s:tab:sim:power:2}
\newcolumntype{C}[1]{>{\hsize=#1\hsize\centering\arraybackslash}X}
\newcolumntype{Z}{>{\centering\arraybackslash}X}
\begin{tabularx}{\textwidth}{l Z@{\hskip 6pt}Z@{\hskip 6pt}Z Z@{\hskip 6pt}Z@{\hskip 6pt}Z Z@{\hskip 6pt}Z@{\hskip 6pt}Z} 
\toprule
...
\begin{table}[t!]
\footnotesize{
\caption{Power of the test for different number of time series $n \in \{5, 10, 50\}$, $\sigma = 10$ (different locations).}\label{s:tab:sim:power:3}
\newcolumntype{C}[1]{>{\hsize=#1\hsize\centering\arraybackslash}X}
\newcolumntype{Z}{>{\centering\arraybackslash}X}
\begin{tabularx}{\textwidth}{l Z@{\hskip 6pt}Z@{\hskip 6pt}Z Z@{\hskip 6pt}Z@{\hskip 6pt}Z Z@{\hskip 6pt}Z@{\hskip 6pt}Z} 
\toprule
...
\begin{table}[t!]
\footnotesize{
\caption{Power of the test for different number of time series $n \in \{5, 10, 50\}$, $\sigma = 20$ (different locations).}\label{s:tab:sim:power:4}
\newcolumntype{C}[1]{>{\hsize=#1\hsize\centering\arraybackslash}X}
\newcolumntype{Z}{>{\centering\arraybackslash}X}
\begin{tabularx}{\textwidth}{l Z@{\hskip 6pt}Z@{\hskip 6pt}Z Z@{\hskip 6pt}Z@{\hskip 6pt}Z Z@{\hskip 6pt}Z@{\hskip 6pt}Z} 
\toprule
