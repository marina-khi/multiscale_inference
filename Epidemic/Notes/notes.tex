...
\end{subfigure}
\caption{Plot of the functions $\lambda_1$ (black) and $\lambda$ (red) in the simulation scenarios A and B. \textcolor{red}{Change labelling: replace $\lambda_2$ by $\lambda$.}}
\end{figure}
