...
\item In the current COVID-19 crisis, independence across countries $i$ seems to be a fairly reasonable assumption due to severe travel restrictions, the closure of borders, etc. Also note that this assumption can in principle be tested, for example, by applying (extensions of) the tests in ??, ?? or ??. 
