...
\centering
\begin{subfigure}[b]{0.48\textwidth}
\subfloat[][]{\includegraphics[width=\textwidth]{plots/14days/results_cluster_1}\label{fig:cl1_14days}}
\end{subfigure}\hspace{0.25cm}
\begin{subfigure}[b]{0.48\textwidth}
\subfloat[][]{\includegraphics[width=\textwidth]{plots/14days/results_cluster_2}\label{fig:cl2_14days}}
\end{subfigure}\\
\begin{subfigure}[b]{0.48\textwidth}
\subfloat[][]{\includegraphics[width=\textwidth]{plots/14days/results_cluster_3}\label{fig:cl3_14days}}
\end{subfigure}\hspace{0.25cm}
\begin{subfigure}[b]{0.48\textwidth}
\subfloat[][]{\includegraphics[width=\textwidth]{plots/14days/results_cluster_4}\label{fig:cl4_14days}}
\end{subfigure}\\
\begin{subfigure}[b]{0.48\textwidth}
\subfloat[][]{\includegraphics[width=\textwidth]{plots/14days/results_cluster_5}\label{fig:cl5_14days}}
\end{subfigure}\hspace{0.25cm}
\begin{subfigure}[b]{0.48\textwidth}
\subfloat[][]{\includegraphics[width=\textwidth]{plots/14days/results_cluster_6}\label{fig:cl6_14days}}
\end{subfigure}
\end{figure}
...
\centering
\begin{subfigure}[b]{0.48\textwidth}
\subfloat[][]{\includegraphics[width=\textwidth]{plots/14days/results_cluster_7}\label{fig:cl7_14days}}
\end{subfigure}
